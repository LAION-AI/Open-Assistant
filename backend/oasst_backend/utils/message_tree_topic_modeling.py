...
from similarity_functions import embed_data, compute_cos_sim_kernel, k_hop_message_passing_sparse
...
def load_topic_model():
    ...
    topic_model = BERTopic(nr_topics="auto", min_topic_size=10, representation_model=representation_model, vectorizer_model=vectorizer_model, ctfidf_model=ctfidf_model, embedding_model=model)
    return topic_model
