...
os.makedirs(f"model_store_rm/{model_name}/1", exist_ok=True)
traced_script_module.save(f"model_store_rm/{model_name}/1/traced-model.pt")

config_path = os.path.join("configs", "triton_config_rm.pbtxt")
...
with open(f"model_store_rm/{model_name}/config.pbtxt", "w") as f:
    f.write(config)
