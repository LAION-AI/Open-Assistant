...
from model_training.custom_datasets.formatting import DatasetEntryPretrain
...
class RedPajama(Dataset):
    ...
    def __getitem__(self, index) -> DatasetEntryPretrain:
        dialogue = DatasetEntryPretrain(text=self.dataset[index]["text"][: self.char_max_len])
        return dialogue
