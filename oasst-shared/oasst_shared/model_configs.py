...
MODEL_CONFIGS = {
    ...
    "OA_SFT_Llama_30B_1000steps": ModelConfig(
        model_id="OpenAssistant/llama_30b_oasst_latcyr_1000",
        max_input_length=1024,
        max_total_length=2048,
    ),
    "OA_SFT_Llama_30B_400steps": ModelConfig(
...
def get_some_model_config_by_model_id(model_id: str, default_if_not_found: bool = True) -> ModelConfig:
