...
export interface CreatePromptReply extends BaseTask {
...
export type CreateTaskType = CreateInitialPromptTask | CreatePromptReply | CreateAssistantReplyTask | CreatePrompterReplyTask;
