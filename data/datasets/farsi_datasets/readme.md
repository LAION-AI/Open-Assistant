Here are some Farsi (Persian) datasets in order to train baseLLM.
...
The Naab dataset is one of the biggest datasets on Farsi language. It contains
126 GB of Farsi data.
