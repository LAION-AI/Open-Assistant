...
"uk": {
        ...
        7: "Перекладіть на мову {lang2} наступний текст: {opening_quote}{text}{closing_quote}, який походить з мови {lang1}.",
        8: "Як правильно перекласти вислів {opening_quote}{text}{closing_quote}?",
        9: "Будь ласка, перекладіть вислів {opening_quote}{text}{closing_quote} на мову {lang2}.",
        10: "Чи можете ви перекласти наступний вислів: {opening_quote}{text}{closing_quote}?",
        11: "Перекладіть на мову {lang2} вислів {opening_quote}{text}{closing_quote}, що написаний мовою {lang1}.",
    },
    "bg": {
