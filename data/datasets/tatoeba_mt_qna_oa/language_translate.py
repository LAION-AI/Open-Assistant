random_templates_translate = {
    ...
    "de": {
        1: "Übersetze {opening_quote}{text}{closing_quote} auf {lang2}",
        2: "Kannst du das übersetzen {opening_quote}{text}{closing_quote}?",
        3: "Übersetze {opening_quote}{text}{closing_quote}",
        4: "Übersetze {opening_quote}{text}{closing_quote} von {lang1} auf {lang2}",
        5: "Übersetze {opening_quote}{text}{closing_quote} auf {lang2}",
        6: "Wie sagt man {opening_quote}{text}{closing_quote} auf {lang2}?",
        7: "Was ist die korrekte Übersetzung von {opening_quote}{text}{closing_quote}?",
        8: "Wie schreibt man {opening_quote}{text}{closing_quote} auf {lang2}",
        9: "Wie würde man {opening_quote}{text}{closing_quote} auf {lang2} sagen?",
        10: "{lang1}-{lang2}: {opening_quote}{text}{closing_quote}",
    },
    "uk": {
        1: "Переклади для мене {opening_quote}{text}{closing_quote} з цієї мови: {lang1}",
        2: "Як буде {opening_quote}{text}{closing_quote} мовою: {lang2}?",
        3: "Як перекласти на {lang2}: {opening_quote}{text}{closing_quote}?",
        4: "Що означає {opening_quote}{text}{closing_quote}? Переведи",
        5: "Як зрозуміти {opening_quote}{text}{closing_quote}?",
        6: "Ти можеш перекласти цей вислів: {opening_quote}{text}{closing_quote}?",
        7: "Переклади наступний текст {opening_quote}{text}{closing_quote} з мови {opening_quote}{lang1}{closing_quote}",
        8: "Як можна перекласти {opening_quote}{text}{closing_quote}?",
        9: "Переклади {opening_quote}{text}{closing_quote} на {lang2}",
        10: "Чи можеш ти перекласти це {opening_quote}{text}{closing_quote}?",
    ...
    "ca": {
        1: "Com puc traduir {opening_quote}{text}{closing_quote} a {lang2}?",
    ...
    "cs": {
        1: "Jak přeložit {opening_quote}{text}{closing_quote} do {lang2}?",
    ...
    "fr": {
        1: "Traduis {opening_quote}{text}{closing_quote} en {lang2} depuis {lang1}",
    ...
    "sr": {
        ...
        8: "Молим те, преведи {opening_quote}{text}{closing_quote} на {lang2}",
        9: "Како се преводи реч {opening_quote}{text}{closing_quote} на {lang2}?",
        10: "Објасни ми шта значи реч {opening_quote}{text}{closing_quote} на {lang2}",
        11: "{lang1}-{lang2}: {opening_quote}{text}{closing_quote}",
    },
    "sv": {
        1: "Översätt {opening_quote}{text}{closing_quote} till {lang2}",
        ...
        5: "Hur kan jag översätta {opening_quote}{text}{closing_quote} till {lang2}?",
        ...
        8: "Jag behöver hjälp med att översätta {opening_quote}{text}{closing_quote} till {lang2}",
