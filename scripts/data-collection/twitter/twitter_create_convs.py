...
class ConversationTreeNode():
    ...
    def get_children(self,tweet_id, children_df):
        ...
        if len(children_dicts)>0:
            children = [ConversationTreeNode(tweet_id = c["id"],
...
class ConversationTree():
    def __init__(self,tweet_id,prompt_user,from_df,children_df,r_metadata=None):
        ...
        self.root = ConversationTreeNode(tweet_id=tweet_id,
...
conv_tree_list = [ConversationTree(tweet_id=r["id"],
                                   prompt_user=r["user_id"],
                                   from_df=origin_tweets,
                                   children_df=p_df_replies_only,
                                   r_metadata=r) 
